...
WARDEN_HIT_RECT = pg.Rect(0, 0, TILESIZE * 3, TILESIZE * 3)
# Warden is the second boss and is tuned around clearing summons before damaging the boss.
WARDEN_MAX_HEALTH = 1800
WARDEN_CONTACT_DAMAGE = 30
WARDEN_CONTACT_COOLDOWN = 850
WARDEN_PROJECTILE_DAMAGE = 20
WARDEN_PROJECTILE_SPEED = 240
WARDEN_PROJECTILE_LIFETIME = 3200
WARDEN_SHOT_COOLDOWN = 650
WARDEN_SUMMON_COUNT = 3
WARDEN_WAIT_TIME = 900
WARDEN_SHOOT_TIME = 2200
WARDEN_VULNERABLE_TIME = 3500
WARDEN_RECOVER_TIME = 900
